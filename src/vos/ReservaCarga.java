...
public class ReservaCarga extends Reserva {
	...
	public ReservaCarga(int id, String idVuelo, int idRemitente, String tipoIdRemitente, int idCarga, String fecha, String tipoReserva, String aeroSal, String aeroLleg) {
